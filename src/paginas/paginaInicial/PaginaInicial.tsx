        ...
        <AppBar position="sticky" className="appbar">
            ...
            <Grid container xs={12}>
                ...
                <Grid container md={12}>
                    ...
                    <Grid item md={4} className="cartao-valores" >
                ...
                <Grid container md={12} spacing={3} className="tecnologias">
                    <Grid item md={12}>
                        <Typography className="subtitulos">
                            Tecnologias utilizadas:
                        </Typography>
                    </Grid>
                    <Grid item md={2} className="cartao-tecnologia" >
                ...
                <Grid container md={12} className="time-info">
                    ...
                    <Grid item md={2} className="cartao-time" >
                        ...
                        <Typography>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde fugit tempora excepturi impedit optio, eligendi Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel doloribus iusto laudantium sapiente dicta.
                        </Typography>
                        <Box>
